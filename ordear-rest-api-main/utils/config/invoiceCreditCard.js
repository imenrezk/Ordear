                                                          ...
                                                          <td class="v-container-padding-padding"
                                                              ...
                                                              <div class="v-text-align"
                                                                  ...
                                                                  <p style="font-size: 14px; line-height: 140%;">
                                                                      <strong><span
                                                                              style="font-size: 16px; line-height: 22.4px;"> ${req.order.taxFK ? 'Billed To' : ""}
                                                      ...
                                                      <tr>
                                                          <td class="v-container-padding-padding"
                                                             ...
                                                             <div class="v-text-align"
                                                                 ...
                                                                 ${req.order.taxFK ?
                                                                    ` <p style="font-size: 14px; line-height: 140%;">
                                                                    <span style={{ fontSize: '16px', lineHeight: '22.4px', fontWeight: 'bold' }}>${ req.order.taxFK.typeTax},</span>  
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">                                                              
                                                                         <span style={{ fontSize: '16px', lineHeight: '22.4px', fontWeight: 'bold' }}>${req.order.taxFK.title},</span>
                                                                   </p>
                                                                    <p style="font-size: 10px; line-height: 140%;"><span
                                                                            style="font-size: 15px; line-height: 22.4px;">${ req.order.taxFK.idNumber},</span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">                                                              
                                                                         <span style={{ fontSize: '16px', lineHeight: '22.4px', fontWeight: 'bold' }}>${  req.order.taxFK.address },</span>
                                                                   </p>
                                                                   <p style="font-size: 14px; line-height: 140%;">                                                              
                                                                         <span style={{ fontSize: '16px', lineHeight: '22.4px', fontWeight: 'bold' }}>${ req.order.taxFK.phoneNumbe},</span>
                                                                   </p>`
                                                                   : ""}
                                                              </div>
...
module.exports = invoiceCreditCardToSend;
