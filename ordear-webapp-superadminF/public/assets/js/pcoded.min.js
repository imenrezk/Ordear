...
function handleMobileNavbar() {
    ...
    // Close mobile menu when clicking outside the navbar or on the close button
    $(".pcoded-main-container, .pcoded-header, .search-close").click(function () {
      if (windowWidth < 992 && navbar.hasClass("mob-open")) {
        navbar.removeClass("mob-open");
        $("#mobile-collapse, #mobile-collapse1").removeClass("on");
      }
    });
  
    // Toggle mobile header/navbar
    $("#mobile-header").click(function () {
      $(".navbar-collapse, .m-header").slideToggle();
    });
  }
  
  // Call the function to initialize the mobile navbar handling
